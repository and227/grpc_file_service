...
func (c *fileServiceClient) List(ctx context.Context, in *FileListRequest, opts ...grpc.CallOption) (*FileListResponse, error) {
...
func (UnimplementedFileServiceServer) List(context.Context, *FileListRequest) (*FileListResponse, error) {
...
func _FileService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).List(ctx, req.(*FileListRequest))
	}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "file_proto/files.proto",
}
